...
from schemas.workflow import SurveyStatus
...
# Create/Update/Response models for API
class INSTATSurveyCreate(INSTATSurveyBase):
    """Model for creating INSTAT surveys"""
    pass


class INSTATSurveyUpdate(BaseModel):
    """Model for updating INSTAT surveys"""
    Title: Optional[str] = None
    Description: Optional[str] = None
    Domain: Optional[INSTATDomain] = None
    Category: Optional[SurveyCategory] = None
    ReportingCycle: Optional[ReportingCycle] = None
    FiscalYear: Optional[int] = None
    TargetAudience: Optional[List[str]] = None
    GeographicScope: Optional[List[str]] = None
    ImplementingUnit: Optional[str] = None
    ComplianceFramework: Optional[List[str]] = None
    InternationalStandards: Optional[List[str]] = None
    EstimatedDuration: Optional[int] = None
    RequiredSkills: Optional[List[str]] = None
    BudgetCategory: Optional[str] = None


class INSTATSurveyResponse(INSTATSurveyBase):
    """Model for INSTAT survey responses"""
    SurveyID: int
    CreatedDate: Optional[datetime] = None
    ...
    DomainSpecificFields: Optional[Dict[str, Any]] = None
...
class SurveyTemplateCreate(BaseModel):
    """Model for creating survey templates"""
    TemplateName: str
    Domain: INSTATDomain
    Category: SurveyCategory
    Version: str = "1.0.0"
...
class SurveyTemplateResponse(SurveyTemplate):
...
class INSTATQuestionCreate(BaseModel):
    """Model for creating INSTAT questions"""
    SurveyID: int
    ...
    IndicatorCode: Optional[str] = None
    DataSource: Optional[str] = None
    CollectionMethod: Optional[str] = None
    QualityRequirements: Optional[Dict[str, Any]] = None
    ValidationRules: Optional[Dict[str, Any]] = None
    DependsOnQuestion: Optional[int] = None
    QuestionTextEN: Optional[str] = None
    QuestionTextFR: Optional[str] = None
...
class INSTATQuestionResponse(INSTATQuestionCreate):
    """Response model for INSTAT questions"""
    QuestionID: int
...
class SurveyMetricsResponse(BaseModel):
    """Response model for survey metrics"""
    MetricID: int
    SurveyID: int
    TotalResponses: Optional[int] = None
    CompletionRate: Optional[float] = None
    AverageCompletionTime: Optional[float] = None
    DataQualityScore: Optional[float] = None
    ValidationErrorRate: Optional[float] = None
    IncompleteResponses: Optional[int] = None
    ResponseByRegion: Optional[Dict[str, Any]] = None
    ResponseTrend: Optional[Dict[str, Any]] = None
    DataCollectionCost: Optional[float] = None
    TimeToComplete: Optional[int] = None
...
class DataExportCreate(BaseModel):
    """Model for creating data export configurations"""
    SurveyID: int
    ExportFormat: str  # PDF, Excel, CSV, JSON
    ExportType: str    # Full, Summary, Dashboard
    ExportConfig: Optional[Dict[str, Any]] = None
...
class DataExportResponse(DataExportCreate):
    """Response model for data export configurations"""
    ExportID: int
    CreatedDate: Optional[datetime] = None
    LastExported: Optional[datetime] = None
    ExportCount: Optional[int] = None
